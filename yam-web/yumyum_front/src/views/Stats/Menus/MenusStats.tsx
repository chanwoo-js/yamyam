...
const renderActiveShape = (props: any) => {
    ...
    return (
        <g>
            ...
            <text x={cx} y={cy} dy={8} textAnchor="middle" fontSize={25} fontWeight={600} fill={fill}>
                {payload.dailyData}
            </text>
            <text x={ex + (cos >= 0 ? 1 : -1) * 12} y={ey} textAnchor={textAnchor} fontSize={20} fontWeight={500} fill="#1230AE">
                {`${payload.name} 판매량 [${value}개]`}
            </text>
